...
export default function About() {
  return (
    <Container maxWidth="lg">
      ...
      <Typography pb={5}>
        元々は広告・人材・飲食など、いろいろな業界でお仕事をさせていただきました。<br />
      ...
      <Grid container>
        <Grid item xs={4}>
          <Card sx={{ maxWidth: 345 }}>
            ...
            <CardActions>
              <Button size="small">
                <a href="https://kys-consulting.com/" target="_blank">OPEN SITE</a>
              </Button>
            </CardActions>
          </Card>
        </Grid>
        <Grid item xs={4}>
          <Card sx={{ maxWidth: 345 }}>
            ...
            <CardActions>
              <Button size="small">
                <a href="https://amore.escrit.jp/howto/" target="_blank">OPEN SITE</a>
              </Button>
            </CardActions>
          </Card>
        </Grid>
        <Grid item xs={4}>
          <Card sx={{ maxWidth: 345 }}>
            ...
            <CardActions>
              <Button size="small">
                <a href="https://amore.escrit.jp/lp/" target="_blank">OPEN SITE</a>
              </Button>
            </CardActions>
          </Card>
        </Grid>
